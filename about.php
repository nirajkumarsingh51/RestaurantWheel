...
<head>
<meta charset="utf-8">
<title>About Us || Restaurant Wheel</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/5.jpg);">
    	<div class="auto-container">
            ...
            <h2>About Us</h2>
        <h4 style="color: rgb(47 202 94); font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">Welcome to Restaurant Wheel, where flavor meets innovation! Established in 2024, our restaurant is a haven for food lovers who appreciate not just good taste but a memorable dining experience. Our journey began with a passion to bring diverse and flavorful cuisines to your table, offering a unique blend of traditional and contemporary dishes.</h4>
        </div>
    </section>
    <!--Page Title-->
    
    <!--Restaurant Section-->
    <section class="restaurant alternate">
    	<div class="auto-container">
        	...
        	<div class="row clearfix">
            	...
            	<div class="services-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="https://en.wikipedia.org/wiki/Pan_pizza" target="_blank">Pan Pizza</a></h3>
            	...
            	<div class="services-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="https://en.wikipedia.org/wiki/Burger" target="_blank">Burger</a></h3>
                        <div class="text">Vivamus sed fermentum tellus. Donec quis elit sapien. Aliquam commodo tortor nisi, nec varius mi finibus at.  ut ullamcorper volutpat lectusu</div>
                        <a class="read-more" href="blog-single.html">Read More</a>
                    </div>
                </div>
            	...
            	<div class="services-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <h3><a href="https://en.wikipedia.org/wiki/Fish" target="_blank">Fish</a></h3>
                        <div class="text">Vivamus sed fermentum tellus. Donec quis elit sapien. Aliquam commodo tortor nisi, nec varius mi finibus at.  ut ullamcorper volutpat lectusu</div>
                        <a class="read-more" href="blog-single.html">Read More</a>
                    </div>
                </div>
    	...
    	<div class="auto-container">
        	<div class="row clearfix">
            	...
            	<div class="image-column col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<figure class="image-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        	<img src="images/resource/master-chef.png" alt="" />
                        </figure>
                    </div>
                </div>
    ...
    <section class="services-section">
        ...
        <div class="auto-container">
        	...
        	<div class="row clearfix">
            	<!--Our Team Member Asmit kumar Block-->
            	<div class="services-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<!--Icon Box-->
                    	<div class="icon-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        	<img src="images/Devlopers/Asmit_kumar.jpg" alt="Asmi kumar" style="width: 100%; max-width: 300px; height: 300px; object-fit: cover;" />
                        </div>
                        <h3>Asmit Kumar <h4>Assistant Developer</h4></h3>
                        <div class="text">
                            "Hi, I’m Asmit Kumar, an enthusiastic Assistant Developer 
                            excited to dive into the world of web development. 
                            My role in the restaurant website project allows me to
                             work on the frontend, where I bring designs to life using HTML and CSS . 
                             I love collaborating with my teammates to create an engaging user experience,
                             and I'm constantly exploring new ideas to make our site even better. 
                        </div>
                        <a class="read-more" href="https://www.linkedin.com/in/asmit-kumar-b4a150233/" target="_blank">Read More</a>
                         ...
                         <ul class="social-icon-two">
                            ...
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
                            <li><a href="https://www.linkedin.com/in/asmit-kumar-b4a150233/" target="_blank"><span class="fab fa-linkedin-in"></span></a></li>
                ...
                <!--Our Team Member Niraj Kumar SIngh Block-->
            	<div class="services-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<!--Icon Box-->
                    	<div class="icon-box wow fadeIn" data-wow-delay="300ms" data-wow-duration="1500ms">
                        	<img src="images/Devlopers/Niraj_kumar_singh.png" alt="Niraj Kumar Singh" style="width: 100%; max-width: 300px; height: 300px; object-fit: cover;" />
                        </div>
                        <h3>Niraj Kumar Singh <h4>Devloper & Team leader</h4></h3>
                        <div class="text">"I am Niraj Kumar Singh, a passionate Developer 
                            with a love for crafting innovative web solutions. Currently leading
                             the development for our restaurant website, I focus on backend architecture,
                              ensuring that everything runs smoothly from user authentication to order management.
                               I thrive on tackling complex challenges and finding efficient solutions, and I’m always eager
                                to learn new technologies. </div>
                        <a class="read-more" href="https://nirajkrsingh.vercel.app/" target="_blank">Read More</a>
                         ...
                         <ul class="social-icon-two">
                            ...
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
                            <li><a href="https://www.linkedin.com/in/niraj-kumar-singh-116437257/" target="_blank"><span class="fab fa-linkedin-in"></span></a></li>
                        </ul>
                    </div>
                </div>
                
                <!--Our Team Member Esha Kumari Block-->
            	<div class="services-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<!--Icon Box-->
                    	<div class="icon-box wow fadeIn" data-wow-delay="600ms" data-wow-duration="1500ms">
                        	<img src="images/Devlopers/esha_kumari.jpg" alt="Esha Kumari" style="width: 100%; max-width: 300px; height: 300px; object-fit: cover;" />
                        </div>
                        <h3>Esha Kumari <h4>Design Lead</h4></h3>
                        <div class="text">
                            "Hello! I’m Esha Kumari, the Design Lead for our restaurant website project.
                             My passion lies in creating beautiful and intuitive designs that enhance user experience.
                              I enjoy the creative process of developing layouts and selecting colors that 
                              reflect our brand's personality. Working with Niraj and Asmit is inspiring, 
                              as we collaborate to ensure that our designs are not only stunning but also functional. 
                        </div>
                        <a class="read-more" href="https://www.linkedin.com/in/esha-kumari-a73337284/" target="_blank">Read More</a>
                         ...
                         <ul class="social-icon-two">
                            ...
                            <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                            <li><a href="#"><span class="fab fa-instagram"></span></a></li>
                            <li><a href="https://www.linkedin.com/in/esha-kumari-a73337284/" target="_blank"><span class="fab fa-linkedin-in"></span></a></li>
                        </ul>
